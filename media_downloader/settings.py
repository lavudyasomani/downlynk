...
SECRET_KEY = 'django-insecure-5#)9q+om%j#l$f#+_r_%dvr5!vrabhwo-fhz3uzj51ok1kxkb#'
...
# Ensure `corsheaders` is properly included
MIDDLEWARE = [
...
LANGUAGE_CODE = 'en-us'              # Language of the project
